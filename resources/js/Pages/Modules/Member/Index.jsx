...
import { Navbar } from '@/Pages/NextUI/Navbar'
import CardOne from '@/Pages/NextUI/CardOne'
import TableMember from '@/Components/NextUITable/TableMember'
    ...
    <div className="h-screen">
      ...
      <main className="py-4 px-6 flex justify-between gap-2">
        ...
        <div className="w-full space-y-3">
          ...
          <TableMember collection={props.members} />
          <TableExample />
        </div>
      </main>
